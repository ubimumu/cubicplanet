/// @description draw_text_colored(x,y,string,alpha)
/// @param x
/// @param y
/// @param string
/// @param alpha
function draw_text_colored(argument0, argument1, argument2, argument3) {
	var _x,_y,_str,_xscale,_yscale,_alpha, _precol, _prealpha, _strab, v1,v2,v3, d_color;
